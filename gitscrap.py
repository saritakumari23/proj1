...
def main():
    ...
    # Search for users in shanghai with >100 followers
    users = scraper.search_users(location='shanghai', min_followers=200)
    ...
    with open('README.md', 'w') as f:
        f.write(f"""# GitHub Users in shanghai

This repository contains data about GitHub users in shanghai with over 100 followers and their repositories.

## Files

1. `users.csv`: Contains information about {len(users)} GitHub users in shanghai with over 100 followers
